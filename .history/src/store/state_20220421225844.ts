...
import { PrepareOrderInitData, PptxDataConfig, defaultPptxDataConfig } from '@/types/pageData'
...
export interface State {
  ...
  spinning: boolean,
  pageData: PrepareOrderInitData | null;
  pageDataStatus: PageDataStatus;
  fileDataConfig: PptxDataConfig | null;
}
...
export const state: State = {
  ...
  fileDataConfig: defaultPptxDataConfig,
}
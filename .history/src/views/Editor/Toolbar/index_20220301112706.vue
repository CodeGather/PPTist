<template>
  <div class="toolbar">
    ...
    <div class="content">
      {{toolbarState}}
      <!-- <component :is="currentPanelComponent" :key="currentPanelComponent.name"></component> -->
      <!-- <element-style-panel v-show="toolbarState == 'slideDesign'"></element-style-panel> -->
      <element-style-panel v-show="toolbarState == 'elStylefa-stack-1x'"></element-style-panel>
      <slide-design-panel v-show="toolbarState == 'slideDesignfa-stack-1x'"></slide-design-panel>
      <element-animation-panel v-show="toolbarState == 'slideAnimation1'"></element-animation-panel>
      <slide-animation-panel v-show="toolbarState == 'elAnimation1'"></slide-animation-panel>

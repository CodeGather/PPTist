    ...
    <Dropdown 
      ...
      <template #overlay>
         <Menu size="small">
          ...
          <MenuItem v-if="item.isPhoto" @click="creatElement(item, 'image')"><IconPicture /> 图片</MenuItem>
          <MenuItem v-if="item.isVideo" @click="creatElement(item, 'parent')"><IconVideoTwo /> 视频</MenuItem>

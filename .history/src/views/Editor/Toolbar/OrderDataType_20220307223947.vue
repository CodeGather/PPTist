    ...
    <Dropdown 
      ...
      <template #overlay>
        <Menu size="small" mode="inline">
          ...
          <SubMenu v-for="(t, i) in item.photosText" :key="i" :title="t.name">
            ...
            <MenuItem @click="creatElement(item, 'video' )"><IconVideoTwo /> 
          ...
          <SubMenu v-for="(t, i) in item.videosText" :key="i" title="视频">
            <MenuItem @click="creatElement(item, 'text', 'childrenName')"><IconText /> 点位</MenuItem>
            <MenuItem @click="creatElement(item, 'image' )"><IconPicture /> 图片</MenuItem>
            <MenuItem @click="creatElement(item, 'video' )"><IconVideoTwo /> 视频</MenuItem>
          </SubMenu>
          <SubMenu v-for="(t, i) in item.optionsText" :key="i" title="选项">
            <MenuItem @click="creatElement(item, 'text', 'childrenName')"><IconText /> 点位</MenuItem>
            <MenuItem @click="creatElement(item, 'image' )"><IconPicture /> 图片</MenuItem>
            <MenuItem @click="creatElement(item, 'video' )"><IconVideoTwo /> 视频</MenuItem>
          </SubMenu>

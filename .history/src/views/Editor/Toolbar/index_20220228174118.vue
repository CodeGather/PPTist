<template>
  <div class="toolbar">
    ...
    <div class="content">
      <component :is="currentPanelComponent" :key="currentTabIndex"></component>
    </div>
  </div>
</template>
...
export default defineComponent({
  ...
  setup() {
    ...
    const currentPanelComponent = (() => {
      ...
      // }
      // console.log(toolbarState.value)
      return currentTabs[toolbarState.value]
    })

    const currentTabIndex = toolbarState.value

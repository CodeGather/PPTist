<template>
  <div class="multi-position-panel">
    ...
    <Tooltip :mouseLeaveDelay="0" :mouseEnterDelay="0.5" title="店铺名称">
      <Button block @click="drawText('店铺名称', 100, 100)">店铺名称</Button>
    </Tooltip>
  </div>
</template>
...
export default defineComponent({
  ...
  setup() {
    ...
    // 绘制文字范围
    const drawText = (lebel: string, top?: number, left?: number) => {
      createTextElement({
        top: top || 0,
        left: left || 0,
        width: 250,
    ...
    // 绘制文字范围
    const drawShape = () => {
      createImageElement('data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAMgAAADIAQMAAACXljzdAAAABGdBTUEAALGPC/xhBQAAAAFzUkdCAK7OHOkAAAADUExURXZ2djcFI0EAAAAcSURBVFjD7cGBAAAAAMOg+VNf4QBVAQAAAAB8BhRQAAEAnyMVAAAAAElFTkSuQmCC')
    }

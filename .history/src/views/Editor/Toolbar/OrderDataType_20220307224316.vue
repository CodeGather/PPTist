    ...
    <Dropdown 
      ...
      <template #overlay>
        <Menu size="small" mode="inline">
          ...
          <SubMenu key="photosText" title="图片" v-if="item.photosText.length > 0">
           ...
           <SubMenu key="videosText" title="视频" v-if="item.videosText.length > 0">
           ...
           <SubMenu key="optionsText" title="选项" v-if="item.optionsText.length > 0">

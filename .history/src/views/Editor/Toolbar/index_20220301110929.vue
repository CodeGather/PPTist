<template>
  <div class="toolbar">
    ...
    <div class="content">
      ...
      <element-animation-panel v-show="toolbarState == 'slideAnimation'"></element-animation-panel>
      <slide-animation-panel v-show="toolbarState == 'elAnimation'"></slide-animation-panel>
...
export default defineComponent({
  ...
  setup() {
    ...
    const slideTabs = [
      ...
      { label: '下单属性', value: ToolbarStates.ORDRER_TYPE },
      { label: '服务属性', value: ToolbarStates.ORDRER_ATTRIBUTE },

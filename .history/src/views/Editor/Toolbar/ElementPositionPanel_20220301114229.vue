<template>
  <div class="element-positopn-panel" v-if="handleElement">
...
export default defineComponent({
  ...
  setup() {
    ...
    console.log(3333, handleElement.value)
    ...
    const minSize = computed(() => {
      ...
      console.log(11111111, handleElement.value.type)
    ...
    watch(handleElement, () => {
      ...
      console.log(222222, handleElement.value.type)

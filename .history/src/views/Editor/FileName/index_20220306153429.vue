  ...
  <div style="display: flex;">
    <div class="file-section">
      ...
      <textarea
        ...
        placeholder="请输入报告名称"
        @input="$event => handleInput($event, 'name')"
      ></textarea>
    </div>
    ...
    <div class="file-section">
      ...
      <textarea
        ...
        placeholder="请输入导出PPTX文件的名称规则"
        @input="$event => handleInput($event, 'fileName')"
      ></textarea>
    </div>
  </div>
</template>
...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const handleInput = (e: InputEvent, key: string) => {
      ...
      const inputMap = {}
      inputMap[key] = value
      store.commit(MutationTypes.UPDATE_FILEDATA, inputMap)
    }
